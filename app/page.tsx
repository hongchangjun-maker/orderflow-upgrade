    ...
    <section className="operations-showcase">
      ...
      <div className="cockpit-frame">
        ...
        <div className="cockpit-main">
          <div className="cockpit-top"><div><small>운영 대시보드 디자인 예시</small><h3>오늘의 운영</h3></div><span className="live-chip"><i /> PREVIEW</span></div>
          <div className="cockpit-metrics"><article><img src="/visuals/icons/orders.webp" alt="" /><span>오늘 주문</span><strong>2,481</strong><small>예시 지표</small></article><article><img src="/visuals/icons/payment.webp" alt="" /><span>오늘 매출</span><strong>₩42.8M</strong><small>예시 지표</small></article><article><img src="/visuals/icons/delivery.webp" alt="" /><span>처리 중</span><strong>184</strong><small>예시 지표</small></article><article className="warning"><img src="/visuals/icons/inventory.webp" alt="" /><span>재고 주의</span><strong>4</strong><small>예시 지표</small></article></div>
          <div className="cockpit-flow"><div className="panel-head"><div><p className="eyebrow">ORDER PIPELINE</p><h3>주문 처리 흐름</h3></div><span>화면 구성 예시</span></div><div className="status-pipeline demo"><div><span>01</span><strong>86</strong><small>새 주문</small><i /></div><div><span>02</span><strong>52</strong><small>확인</small><i /></div><div><span>03</span><strong>31</strong><small>포장</small><i /></div><div><span>04</span><strong>15</strong><small>배송</small><i /></div><div><span>05</span><strong>2,297</strong><small>완료</small></div></div></div>
        </div>
      </div>
    </section>
